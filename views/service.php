...
<body>
			...
			<div class="row">
				<div class="col-lg-5">
					<div class="service-slider">
						<div class="ss-single">
							<img src="../public/img/service/1.jpg" alt="">
						</div>
						<div class="ss-single">
							<img src="../public/img/service/2.jpg" alt="">
						</div>
						<div class="ss-single">
							<img src="../public/img/service/3.jpg" alt="">
						</div>
					</div>
				</div>
	...
	<div class="service-box-section spad set-bg" data-setbg="../public/img/service-bg.jpg">
		<div class="container">
			<div class="row">
	...
	<section class="promo-section pt-0">
		<div class="promo-box set-bg" data-setbg="../public/img/bg.jpg">
			<div class="container">
				<div class="row">
